...
total_search_parameters = [
    ...
    (
        {"booksGenreId": "001025"},
        lambda p, r, i: assert_eq(
            i["booksGenreId"].startswith(p["booksGenreId"]), True
        ),
    ),
    ...
    (
        {"availability": "1"},
        lambda p, r, i: assert_eq(i["availability"], p["availability"]),
    ),
    (
        {"availability": "3"},
        lambda p, r, i: assert_eq(i["availability"], p["availability"]),
...
book_search_parameters = [
    ...
    (
        ...
        lambda p, r, i: assert_eq(i["booksGenreId"], p["booksGenreId"]),
    ),
    (
        {"elements": "title,author"},
        lambda p, r, i: assert_eq(set(i.keys()), set(p["elements"].split(","))),
    ),
]
